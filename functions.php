...
if ( ! function_exists( 'wilson_web_development_setup' ) ) :
	...
	function wilson_web_development_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'wilson-web-development' ),
			)
		);
...
function wilson_web_development_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'wilson-web-development' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'wilson-web-development' ),
...
function wilson_web_development_scripts() {
	...
	wp_enqueue_style ('theme_styles', get_template_directory_uri().'/css/build_styles.min.css');

	wp_enqueue_script( 'wilson-web-development-navigation', get_template_directory_uri() . '/js/navigation.js', array('jquery'), _S_VERSION, true );
